                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="form-icon position-relative">
                                            ...
                                            <input type="text" class="form-control ps-5 @error('fullname') is-invalid @enderror" placeholder="Nama Lengkap" name="fullname" value="{{ $profile->fullname }}" autocomplete="fullname">
                                            @error('fullname')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
