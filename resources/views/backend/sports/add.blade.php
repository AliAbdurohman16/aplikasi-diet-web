                            ...
                            <div class="row mt-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="row">
                                            <div class="col-7 col-sm-8 mb-2">
                                                <input name="five_minute_calories" id="five_minute_calories" type="text" class="form-control @error('five_minute_calories') is-invalid @enderror" placeholder="Jumlah Kalori" value="{{ old('five_minute_calories') }}">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="row">
                                            <div class="col-7 col-sm-8 mb-2">
                                                <input name="fifteen_minute_calories" id="fifteen_minute_calories" type="text" class="form-control @error('fifteen_minute_calories') is-invalid @enderror" placeholder="Jumlah Kalori" value="{{ old('fifteen_minute_calories') }}">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="row">
                                            <div class="col-7 col-sm-8 mb-2">
                                                <input name="thirty_minute_calories" id="thirty_minute_calories" type="text" class="form-control @error('thirty_minute_calories') is-invalid @enderror" placeholder="Jumlah Kalori" value="{{ old('thirty_minute_calories') }}">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="row">
                                            <div class="col-7 col-sm-8 mb-2">
                                                <input name="one_hour_calories" id="one_hour_calories" type="text" class="form-control @error('one_hour_calories') is-invalid @enderror" placeholder="Jumlah Kalori" value="{{ old('one_hour_calories') }}">
