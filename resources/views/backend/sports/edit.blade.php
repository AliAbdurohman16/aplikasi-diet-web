                            ...
                            <div class="row mt-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3 mb-2">
                                                <img src="{{ asset('storage/sports/' . $sport->image) }}" width="100px" alt="image" class="img-thumbnail img-preview">
                                            </div>
                                            <div class="col-sm-9">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="row">
                                            <div class="col-7 col-sm-8 mb-2">
                                                <input name="set" id="set" type="number" class="form-control @error('set') is-invalid @enderror" placeholder="Jumlah Set" value="{{ $sport->set }}">
                                                @error('set')
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="row">
                                            <div class="col-7 col-sm-8 mb-2">
                                                <input name="time" id="time" type="number" class="form-control @error('time') is-invalid @enderror" placeholder="Waktu" value="{{ $sport->time }}">
                                                @error('time')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="col-5 col-sm-4">
                                                <select name="per" id="per" class="form-control select2 @error('per') is-invalid @enderror">
                                                    ...
                                                    <option value="Detik" {{ $sport->per == 'Detik' ? 'selected' : '' }}>Detik</option>
                                                    <option value="Menit" {{ $sport->per == 'Menit' ? 'selected' : '' }}>Menit</option>
                                                    <option value="Jam" {{ $sport->per == 'Jam' ? 'selected' : '' }}>Jam</option>
                                                </select>
                                                @error('per')
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="row">
                                            <div class="col-7 col-sm-8 mb-2">
                                                <input name="calories" id="calories" type="number" class="form-control @error('calories') is-invalid @enderror" placeholder="Kalori" value="{{ $sport->calories }}">
                                                @error('calories')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="row">
                                            <div class="col-7 col-sm-8 mb-2">
                                                <input name="fat" id="fat" type="number" class="form-control @error('fat') is-invalid @enderror" placeholder="Lemak" value="{{ $sport->fat }}">
                                                @error('fat')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="description" id="summernote" rows="4" class="form-control @error('description') is-invalid @enderror" placeholder="Deskripsi Olahraga">{{ $sport->description }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
