                            ...
                            <tbody>
                                ...
                                @foreach($sports as $sport)
                                    <tr>
                                        ...
                                        <td class="p-3"><img src="{{ asset('storage/sports/' . $sport->image) }}" width="70px" class="img-fluid" alt="image-categories"></td>
                                        <td class="p-3">{{ $sport->name }}</td>
                                        <td class="p-3">{{ $sport->time }} {{ $sport->per }}</td>
                                        <td class="p-3">{{ $sport->calories }} gram</td>
                                        <td class="p-3">{{ $sport->fat }} gram</td>
                                        <td style="width: 25%;">
