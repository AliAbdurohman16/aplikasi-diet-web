...
<div class="container-fluid">
    <div class="layout-specing">
        <div class="d-md-flex justify-content-between align-items-center">
            <h5 class="mb-0">Subkategori</h5>

            <nav aria-label="breadcrumb" class="d-inline-block">
                <ul class="breadcrumb bg-transparent rounded mb-0 p-0">
                    <li class="breadcrumb-item text-capitalize"><a href="#">Subkategori</a></li>
                            ...
                            <tbody>
                                ...
                                @foreach($subcategories as $subcategory)
                                    <tr>
                                        ...
                                        <td class="p-3">{{ $subcategory->slug }}</td>
                                        <td style="width: 25%;">
                                            <button type="button" class="btn btn-warning btn-sm mb-2" data-bs-toggle="modal" data-bs-target="#edit-modal{{ $subcategory->id }}"><i class="fa-solid fa-pen"></i> Edit</button>
                                            <button type="button" class="btn btn-danger btn-sm mb-2 btn-delete" data-id="{{ $subcategory->id }}"><i class="fa-solid fa-trash"></i> Hapus</button>
                                        </td>
                                    </tr>
                                @endforeach
                                <!-- End -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="Nama Subkategori" required>
                                @error('name')
                                    <span class="invalid-feedback errorname" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
...
<!-- Modal Edit -->
@foreach ($subcategories as $subcategory)
<div class="modal fade" id="edit-modal{{ $subcategory->id }}" tabindex="-1" aria-labelledby="LoginForm-title" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded shadow border-0">
            <div class="modal-header border-bottom">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label class="form-label">Nama Subkategori<span class="text-danger">*</span></label>
                                <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ $subcategory->name }}" placeholder="Nama Subkategori" required>
                                @error('name')
                                    <span class="invalid-feedback errorname" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
