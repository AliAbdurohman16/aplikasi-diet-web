        ...
        <div class="d-md-flex justify-content-between align-items-center">
            ...
            <nav aria-label="breadcrumb" class="d-inline-block">
                <ul class="breadcrumb bg-transparent rounded mb-0 p-0">
                    <li class="breadcrumb-item text-capitalize"><a href="#">Pengguna</a></li>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($user->image == 'default/user.png')
                                                <img src="{{ asset($user->image) }}" width="70px" class="img-fluid" alt="image-customers">
                                            @else
                                        ...
                                        <td class="p-3">{{ $user->work }}</td>
                                        <td style="width: 5%;">
                                            <a href="users/{{ $user->id }}/edit" class="btn btn-warning btn-sm mb-2"><i class="fa-solid fa-pen"></i> Edit</a>
